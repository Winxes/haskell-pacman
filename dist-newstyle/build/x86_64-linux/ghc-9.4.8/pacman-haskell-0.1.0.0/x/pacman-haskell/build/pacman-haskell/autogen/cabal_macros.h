...
/* package pacman-haskell-0.1.0.0 */
#ifndef VERSION_pacman_haskell
#define VERSION_pacman_haskell "0.1.0.0"
#endif /* VERSION_pacman_haskell */
#ifndef MIN_VERSION_pacman_haskell
#define MIN_VERSION_pacman_haskell(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_pacman_haskell */
...
#define CURRENT_COMPONENT_ID "pacman-haskell-0.1.0.0-inplace-pacman-haskell"
